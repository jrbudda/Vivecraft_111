...
public class InputInjector {
	...
	private static void putKeyboardEvent(int keycode, boolean state, int ch) throws ReflectiveOperationException {
		...
		if (putKeyboardEvent == null) {
			putKeyboardEvent = keyboardClass.getDeclaredMethod(windows ? "putEvent" : "putKeyboardEvent", Integer.TYPE, Byte.TYPE, Integer.TYPE, Long.TYPE, Boolean.TYPE); // int keycode, boolean state, int ch, long millis/nanos, boolean repeat
